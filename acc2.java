...
interface acc2 {
    ...
    void setPreviousTransaction(int previousTransaction);
    void setCustomerName(String customerName) ;
    void setCustomerID(String customerID) ;

    int getBalance() ;
    //setPreviousTransaction is letter
    String getCustomerName() ;
    String getCustomerID() ;
}

interface xdeposit extends acc2{
    void deposit(int amount);
}
interface xwithdraw extends acc2{
    void withdraw(int amount);
}
interface xPreviousTransaction extends acc2{
    void getPreviousTransaction();
}
interface xcalculateInterest extends acc2{
    void calculateInterest(int years);
}

class acc3 implements xwithdraw,xdeposit,xcalculateInterest,xPreviousTransaction{
    private int balance;
    ...
    public void setPreviousTransaction(int previousTransaction) { this.previousTransaction = previousTransaction; }
